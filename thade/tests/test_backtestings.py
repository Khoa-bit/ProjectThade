...
class ScrapeStockTests(TestCase):
    def test_make_soup_with_valid_url(self):
        ...
        for company_code in company_codes:
            ...
            self.assertIsInstance(make_soup(url), BeautifulSoup, "Return BeautifulSoup Object")
    ...
    def test_make_soup_with_invalid_url(self):
        ...
        for wrong_url in wrong_urls:
            with self.assertRaisesMessage(
                    Exception,
                    "Invalid url (Is the url from https://www.cophieu68.vn/historyprice.php?): " + wrong_url,
        ...
        for url in invalid_structures:
            with self.assertRaisesMessage(
                    Exception,
                    "Given url doesn't fit scraping structure (Probably due to invalid company code): " + url,
    ...
    def test_fetch_company_with_a_company_code_that_already_exists_in_db(self):
        ...
        self.assertEqual(fetched_company.code, company_in_db.code, "Is the same company")
        self.assertEqual(number_of_companies_before_fetching, number_of_companies_after_fetching,
    ...
    def test_fetch_company_with_a_new_valid_company_code(self):
        ...
        self.assertIsInstance(fetched_company, Company, "Return Company object")
        self.assertEqual(number_of_companies_before_fetching + 1, number_of_companies_after_fetching,
    ...
    def test_clear_records(self):
        ...
        self.assertEqual(Company.objects.first().code, clear_company.code, "The clear company exists in database")
        self.assertEqual(clear_company.record_set.count(), 50,
                         "Exactly 50 new records are created and related to the company")
        self.assertEqual(Record.objects.count(), 60, "Exactly 60 new records exist in db")
        clear_records(clear_company)
        self.assertEqual(Company.objects.first().code, clear_company.code, "The clear company still exists in database")
        self.assertEqual(clear_company.record_set.count(), 0, "No records left are related to the company")
    ...
    def test_request_company_desc(self):
        ...
        self.assertQuerysetEqual(list(Company.objects.all()), [company_AAA, company_HPG], msg="2 companies exist in db")
    ...
    def test_request_records_without_last_update(self):
        ...
        self.assertNotEqual(company.record_set.count(), 0,
    ...
    def test_parse_and_save_record_without_last_update(self):
        ...
        self.assertEqual(company.record_set.count(), 1,
