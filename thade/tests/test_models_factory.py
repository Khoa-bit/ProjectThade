...
class ModelsFactoryTest(TestCase):
    def test_default_seed(self):
        ...
        self.assertEqual(
            ...
            '{}{:04}{:02}{:02}'.format(company.code, tz_now.year, tz_now.month, tz_now.day),
            'First record should be timezone.now()'
        )

        self.assertEqual(
            seeded_records.last().rid,
            '{}{:04}{:02}{:02}'.format(company.code, tz_4_days_ago.year, tz_4_days_ago.month, tz_4_days_ago.day),
            'Last record should be 4 days apart.'
        )
        self.assertIsInstance(company, Company, "Return Company object")
        self.assertEqual(company.record_set.count(), 5,
    ...
    def test_seed_with_input_records(self):
        ...
        self.assertEqual(
            seeded_records.last().rid,
            '{}{:04}{:02}{:02}'.format(company.code, tz_49_days_ago.year, tz_49_days_ago.month, tz_49_days_ago.day),
            'Last record should be 49 days apart.'
        )
        self.assertIsInstance(company, Company, "Return Company object")
        self.assertEqual(company.record_set.count(), 50,
                         "Exactly 50 new records are created and related to the company")
        self.assertEqual(Record.objects.count(), 50, "Exactly 50 new records exist in db")
    ...
    def test_seed_with_input_days_from_now(self):
        ...
        self.assertEqual(
            seeded_records.first().rid,
            '{}{:04}{:02}{:02}'.format(company.code, tz_10_days_ago.year, tz_10_days_ago.month, tz_10_days_ago.day),
            'First record should be 10 days after timezone.now()'
        )

        self.assertEqual(
            seeded_records.last().rid,
            '{}{:04}{:02}{:02}'.format(company.code, tz_14_days_ago.year, tz_14_days_ago.month, tz_14_days_ago.day),
    ...
    def test_seed_with_input_records_and_days_from_now(self):
        ...
        self.assertEqual(
            seeded_records.last().rid,
            '{}{:04}{:02}{:02}'.format(company.code, tz_59_days_ago.year, tz_59_days_ago.month, tz_59_days_ago.day),
    ...
    def test_seed_with_input_company(self):
        ...
        self.assertEqual(company1.record_set.count(), 5,
                         "Exactly 5 new records are created and related to the company 1")
        self.assertEqual(seed_company.record_set.count(), 5,
                         "Exactly 5 new records are created and related to the company 1")
        self.assertEqual(Record.objects.count(), 5, "Exactly 5 new records exist in db")
        ...
        self.assertEqual(company2.record_set.count(), 5,
                         "Exactly 5 new records are created and related to the company 2")
        self.assertEqual(seed_company_factory.record_set.count(), 5,
                         "Exactly 5 new records are created and related to the company 2")
        self.assertEqual(Record.objects.count(), 10, "Exactly 10 new records exist in db")
    ...
    def test_seed_with_input_records_and_company(self):
        ...
        self.assertEqual(seed_company_factory.record_set.count(), 50,
                         "Exactly 50 new records are created and related to the seed company")
        self.assertEqual(Record.objects.count(), 50, "Exactly 50 new records exist in db")
    ...
    def test_seed_with_input_company_with_records(self):
        ...
        self.assertEqual(Record.objects.count(), 1, "Exactly 1 record exists in db  after fail seeding")
        ...
        self.assertEqual(Record.objects.count(), 6, "Exactly 6 records exist in db  after fail seeding")
        with self.assertRaisesMessage(
                Exception,
                "Company already has records.\n{} has {} record(s)".format(seed_company,
